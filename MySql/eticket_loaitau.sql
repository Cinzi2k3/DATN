...
CREATE TABLE `loaitau` (
  `maloaitau` int NOT NULL AUTO_INCREMENT,
  `tenloaitau` varchar(45) DEFAULT NULL,
...
INSERT INTO `loaitau` VALUES (1,'Tàu Tốc Hành'),(2,'Tàu Chất Lượng Cao'),(3,'Tàu Thường');
...
-- Dump completed on 2025-06-08 17:08:09
