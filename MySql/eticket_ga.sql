...
CREATE TABLE `ga` (
  `maga` int NOT NULL AUTO_INCREMENT,
  `tenga` varchar(45) DEFAULT NULL,
...
INSERT INTO `ga` VALUES (1,'Hà Nội','Hà Nội'),(2,'Sài Gòn','Sài Gòn'),(3,'Đã Nẵng','Đà Nẵng'),(4,'Nha Trang','Nha Trang');
