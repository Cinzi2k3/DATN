...
CREATE TABLE `thanhtoan` (
  ...
  KEY `v_idx` (`mave`),
  KEY `nd_idx` (`manguoidung`),
  CONSTRAINT `nd` FOREIGN KEY (`manguoidung`) REFERENCES `nguoidung` (`manguoidung`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `v` FOREIGN KEY (`mave`) REFERENCES `ve` (`mave`) ON DELETE CASCADE ON UPDATE CASCADE
